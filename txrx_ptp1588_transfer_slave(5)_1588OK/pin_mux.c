...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
			IOMUXC_GPIO_B1_00_LPUART4_TX,        /* GPIO_AD_B0_12 is configured as LPUART1_TX */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_B1_01_LPUART4_RX,        /* GPIO_AD_B0_13 is configured as LPUART1_RX */
      0U);                                       /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
...
//                                                 Hyst. Enable Field: Hysteresis Disabled */
  ...
  IOMUXC_SetPinConfig(
      ...
      0xB0A9u);                               /* Slew Rate Field: Fast Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_B1_00_LPUART4_TX,        /* GPIO_AD_B0_12 PAD functional properties : */
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_B1_01_LPUART4_RX,        /* GPIO_AD_B0_13 PAD functional properties : */
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
...
*/
  ...
  IOMUXC_SetPinConfig(
	...
	IOMUXC_SetPinMux(
      IOMUXC_GPIO_SD_B0_00_GPIO3_IO12,        /* GPIO_AD_B1_09 is configured as GPIO1_IO23 */  //in OK1061  is  D7
      0U);
	IOMUXC_SetPinConfig(
