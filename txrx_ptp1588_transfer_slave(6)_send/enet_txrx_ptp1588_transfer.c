...
int main(void)
{
    ...
    //gpio_pin_config_t gpio_config = {kGPIO_DigitalOutput, 0, kGPIO_NoIntmode};
		...
		gpio_pin_config_t sw_config = {kGPIO_DigitalInput, 0, 3};
				...
				if (g_InputSignal)
				{
						...
						//{
								...
								g_c += 1;
									...
									//#if 0
									if (g_theTime.nanosecond > HALF_SEC && g_theTime.nanosecond < (HALF_SEC + 5000))
									{
											my_offset += (g_theTime.nanosecond - HALF_SEC);
									}
									else if (g_theTime.nanosecond < HALF_SEC && g_theTime.nanosecond > (HALF_SEC - 5000))
									{
											my_offset += (g_theTime.nanosecond - HALF_SEC);
									}
									else
